...
import com.google.cloud.bigquery.connector.common.{BigQueryClient, BigQueryReadClientFactory}
...
class BigQueryRelationProviderSuite
  ...
  @Mock
  private var bigQueryReadClientFactory: BigQueryReadClientFactory = _
  ...
  before {
    ...
    val injector = Guice.createInjector(new Module {
      override def configure(binder: Binder): Unit = {
        ...
        binder.bind(classOf[BigQueryReadClientFactory]).toInstance(bigQueryReadClientFactory)
      }
    })
